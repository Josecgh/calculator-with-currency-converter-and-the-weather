...
Se deberá utilizar la siguiente API: [https://currencyfreaks.com/](https://currencyfreaks.com/)
Requisitos mínimos - El Tiempo:

Se deberá utilizar la siguiente API: [https://www.el-tiempo.net/api](https://www.el-tiempo.net/api)
